...
fun WeatherAppBar(
    ...
    if (showDaillog.value) {
        ShowSettingDropMenu(showDaillog = showDaillog, navController = navController)
    }
    TopAppBar(title = {
        Text(
            text = title,
        ...
        if (isMainScreen) {
            ...
            IconButton(onClick = { showDaillog.value = true }) {
...
@Composable
fun ShowSettingDropMenu(showDaillog: MutableState<Boolean>, navController: NavController) {
